  ...
  items: [
    {
      ...
      authors: [ 'עברית english', ],
    },
    {
      image: {
        accessibility: 'היום באנפילד',
        title: 'היום באנפילד',
        aspects: {
          full: { width: '2280', height: '1260', x: '-800', y: '0', },
        },
        isAnimated: false,
        imgArray: [ { imgName: 'image/4079233716.jpg', version: '1521316085', }, ],
        imageType: 'image',
        inputTemplate: 'com.tm.Image',
        contentId: '1.5911776',
        contentName: ' היום באנפילד',
      },
      firstParagraph:
    ...
    },
    {
      image: {
        ...
        credit: 'Credit',
        isAnimatedGif: true,
        imgArray: [ { imgName: 'image/2932964102.gif', version: '1521744419', }, ],
        imageType: 'image',
        alt: 'this alt from data',
        contentId: '1.5936866',
        aspects: {
          full: { width: '250', height: '150', x: '0', y: '0', },
        },
      },
      firstParagraph: '<p>89u</p...</p>',
      publishDate: 1501158782370,
      contentId: '1.5764',
      title: 'מי המנצחת הגדולה במבחן הרכבים ההיברידיים של אוטו?',
      commentsCounts: 0,
      path: '/1.5764',
    ...
    },
    {
      ...
      title: 'long title .. מקומות בארץ שבהם תקבלו דונם קרקע בחינם לבנות בית',
      commentsCounts: 71,
      path: '/.premium-1.1204',
      subtitleMobile:
    ...
    },
    {
      ...
      leadText:
        'השמחה לאיד היא תכונה שמשותפת לרבים ויש בה כדי להצביע על עליבותם ומידת קינאתם',
      title:
        'long title should be like.. מקומות בארץ שבהם תקבלו דונם קרקע בחינם לבנות בית',
      commentsCounts: 71,
      path: '/.premium-1.1204',
      subtitleMobile:
        'קרקע של דונם לבנות את וילת חלומותיכם לצד קיצור תהליכים בירוקרטיים ומענקים למימון הבית והעסק: הצצה למקומות בישראל שבהם זה קורה ובישראלים שכבר עשו זאת',
