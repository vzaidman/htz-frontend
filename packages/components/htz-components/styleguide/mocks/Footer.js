export default () => ({
  head: [
    ...
    {
      text: 'אודות הארץ',
      href: 'https://www.haaretz.co.il/misc/about-haaretz',
    },
  ...
  toolbox: [
    {
      text: 'חיבור מינוי דיגיטלי',
      href: 'https://www.haaretz.co.il/misc/entitlement',
    },
    {
      text: 'עדכונים במייל',
      href: 'https://www.haaretz.co.il/personal-area/newsletter',
    ...
    {
      text: 'שירות למנויים',
      href: 'https://www.haaretz.co.il/personal-area/my-account',
    },
  ],
});
