...
const colorPropTypes = {
  /**
   * Foreground color-name or [ color-name, tint ] value, according to [color pallete](https://haaretz.github.io/htz-frontend/docs/htz-theme//#color-palette)
   */
  color: colorAttrPropType.isRequired,
  /**
   * Background color-name or [ color-name, tint ] value, according to [color pallete](https://haaretz.github.io/htz-frontend/docs/htz-theme//#color-palette)
   */
...
const styleColor = ({ color, bgColor, miscStyles, theme, }) => {
  ...
  if (bgColor) {
    style.backgroundColor = theme.color(
      ...(typeof bgColor === 'string' ? [ bgColor, ] : bgColor)
    );
  }
...
const ColorStyled = createComponent(styleColor, ColorComponent, [
  'tagName',
  'children',
]);
