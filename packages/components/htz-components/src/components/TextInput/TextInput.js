...
class TextInput extends Component {
  constructor(props) {
    super(props);
    /**
     * boldActive, italicActive and isFocused are used to control the styles of the component
     * disableBlur is needed to keep the caret position after clicking one of the format buttons,
     * and make sure the focused style doesnt change when clicking one of these buttons.
     * inputId, labelId and noteId are used for a11y reasons.
     */
    this.state = {
      boldActive: false,
      disableBlur: false,
    ...
    this.setFormatButtonsState = this.setFormatButtonsState.bind(this);
  }
