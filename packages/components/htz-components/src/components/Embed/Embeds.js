...
const views = {
  ArtiMedia: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/ArtiMedia.js')),
  BandCamp: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/BandCamp.js')),
  Facebook: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Facebook.js')),
  FacebookComments: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/FacebookComments.js')),
  FileUpload: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/FileUpload.js')),
  Giphy: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Giphy.js')),
  GoogleMap: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/GoogleMap.js')),
  Instagram: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Instagram.js')),
  NYT: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/NYT.js')),
  Pinterest: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Pinterest.js')),
  PlayBuzz: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/PlayBuzz.js')),
  StandardAudio: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/StandardAudio.js')),
  StandardVideo: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/StandardVideo.js')),
  Tline: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Tline.js')),
  Twitter: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Twitter.js')),
  Vimeo: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Vimeo.js')),
  Waze: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Waze.js')),
  Youtube: dynamic(import('/opt/htz-frontend/packages/components/htz-components/src/components/Embed/elements/Youtube.js')),
};
