...
const StyledSendCommentButton = createComponent(sendCommentButtonStyle, 'button');
    ...
    <Form>
      <InputWrapper>
        <InputLabel text="שם" styleObject={inputLabelStyle}>
          <TextInput aria-describedby={'note-name'} styleObject={textInputStyle} />
        </InputLabel>
      </InputWrapper>
      <InputNote>אנא הזינו שם שיוצג ככותב התגובה</InputNote>
      <InputWrapper>
        <InputLabel text="תגובה" styleObject={inputLabelStyle}>
          <TextInput isTextArea aria-describedby={'note-comment'} styleObject={textInputStyle} />
        </InputLabel>
      </InputWrapper>
      <StyledAddCommentFooter>
        <InputNote>בשליחת תגובה זו הנני מצהיר שהינני מסכים/ה עם תנאי השימוש של אתר הארץ</InputNote>
