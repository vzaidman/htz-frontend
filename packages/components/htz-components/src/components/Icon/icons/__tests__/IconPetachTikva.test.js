...
import IconPetachTikva from '../IconPetachTikva';

describe('<IconPetachTikva />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconPetachTikva size="2rem" />)).toThrow(
  ...
  //     expect(() => felaSnapshotter(<IconPetachTikva color="red" />)).toThrow(
  //       /is not a named-color/
  //     );
  //   });
  //   it('throw an error when the value passed to the "color" prop isn't a named color (array of strings)', () => {
  //     expect(() =>
  //       felaSnapshotter(<IconPetachTikva color={[ 'primary', 'nope', ]} />)
  //     ).toThrow(/is not a named-color/);
  //   });
  //   it('throw an error when the value passed to the "fill" prop isn't a named color (string)', () => {
  //     expect(() => felaSnapshotter(<IconPetachTikva fill="red" />)).toThrow(
  //       /is not a named-color/
  //     );
  //   });
  //   it('throw an error when the value passed to the "fill" prop isn't a named color (array of strings)', () => {
  //     expect(() =>
  //       felaSnapshotter(<IconPetachTikva fill={[ 'primary', 'nope', ]} />)
  //     ).toThrow(/is not a named-color/);
  //   });
  // });
  describe('DOM element', () => {
    testCase('render correctly when no props are passed', <IconPetachTikva />);
    testCase(
      'pass attributes defined in the "attrs" prop to the DOM element',
      <IconPetachTikva attrs={{ 'aria-hidden': true, }} />
    );
    testCase('add "id" attribute to DOM element', <IconPetachTikva id="hasId" />);
    testCase(
      'add "onClick" attribute to DOM element',
      <IconPetachTikva id={e => console.log('a')} />
    );
  });

  describe('styles', () => {
    testCase("set icon's color", <IconPetachTikva color={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's fill", <IconPetachTikva fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's size", <IconPetachTikva size={6} />);
    testCase(
    ...
    testCase(
      ...
      <IconPetachTikva miscStyles={{ position: 'relative', }} />
    );
    testCase(
