...
describe('<IconPdf />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconPdf size="2rem" />)).toThrow(
  ...
  describe('styles', () => {
    ...
    testCase("set icon's fill", <IconPdf fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's size", <IconPdf size={6} />);
    testCase(
    ...
    testCase(
      ...
      <IconPdf miscStyles={{ position: 'relative', }} />
    );
    testCase(
