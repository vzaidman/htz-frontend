...
describe('<IconHourglass />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconHourglass size="2rem" />)).toThrow(
  ...
  //     expect(() => felaSnapshotter(<IconHourglass color="red" />)).toThrow(
  //       /is not a named-color/
  //     );
  //   });
  //   it('throw an error when the value passed to the "color" prop isn't a named color (array of strings)', () => {
  //     expect(() =>
  //       felaSnapshotter(<IconHourglass color={[ 'primary', 'nope', ]} />)
  //     ).toThrow(/is not a named-color/);
  //   });
  //   it('throw an error when the value passed to the "fill" prop isn't a named color (string)', () => {
  //     expect(() => felaSnapshotter(<IconHourglass fill="red" />)).toThrow(
  //       /is not a named-color/
  //     );
  //   });
  //   it('throw an error when the value passed to the "fill" prop isn't a named color (array of strings)', () => {
  //     expect(() =>
  //       felaSnapshotter(<IconHourglass fill={[ 'primary', 'nope', ]} />)
  //     ).toThrow(/is not a named-color/);
  //   });
  // });
  describe('DOM element', () => {
    testCase('render correctly when no props are passed', <IconHourglass />);
    testCase(
      'pass attributes defined in the "attrs" prop to the DOM element',
      <IconHourglass attrs={{ 'aria-hidden': true, }} />
    );
    testCase('add "id" attribute to DOM element', <IconHourglass id="hasId" />);
    testCase(
      'add "onClick" attribute to DOM element',
      <IconHourglass id={e => console.log('a')} />
    );
  });

  describe('styles', () => {
    testCase("set icon's color", <IconHourglass color={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's fill", <IconHourglass fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's size", <IconHourglass size={6} />);
    testCase(
    ...
    testCase(
      ...
      <IconHourglass miscStyles={{ position: 'relative', }} />
    );
    testCase(
