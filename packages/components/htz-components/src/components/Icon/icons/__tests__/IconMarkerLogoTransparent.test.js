...
import IconMarkerLogoTransparent from '../IconMarkerLogoTransparent';

describe('<IconMarkerLogoTransparent />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconMarkerLogoTransparent size="2rem" />)).toThrow(
  ...
  describe('DOM element', () => {
    ...
    testCase(
      ...
      <IconMarkerLogoTransparent attrs={{ 'aria-hidden': true, }} />
    );
    testCase(
      'add "id" attribute to DOM element',
      <IconMarkerLogoTransparent id="hasId" />
    );
    testCase(
      'add "onClick" attribute to DOM element',
      <IconMarkerLogoTransparent id={e => console.log('a')} />
    );
  });
  ...
  describe('styles', () => {
    testCase(
      "set icon's color",
      <IconMarkerLogoTransparent color={[ 'primary', 'base', ]} />
    );
    testCase(
    ...
    testCase(
      "set icon's fill",
      <IconMarkerLogoTransparent fill={[ 'primary', 'base', ]} />
    );
    testCase(
    ...
    testCase("set icon's size", <IconMarkerLogoTransparent size={6} />);
    testCase(
    ...
    testCase(
      ...
      <IconMarkerLogoTransparent miscStyles={{ position: 'relative', }} />
    );
    testCase(
