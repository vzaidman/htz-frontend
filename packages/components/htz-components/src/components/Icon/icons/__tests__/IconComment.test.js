...
describe('<IconComment />', () => {
  ...
  describe('DOM element', () => {
    ...
    testCase(
      ...
      <IconComment attrs={{ 'aria-hidden': true, }} />
    );
    testCase('add "id" attribute to DOM element', <IconComment id="hasId" />);
    testCase(
      'add "onClick" attribute to DOM element',
      <IconComment id={e => console.log('a')} />
    );
  });

  describe('styles', () => {
    testCase("set icon's color", <IconComment color={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's fill", <IconComment fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's size", <IconComment size={6} />);
    testCase(
    ...
    testCase(
      ...
      <IconComment miscStyles={{ position: 'relative', }} />
    );
    testCase(
