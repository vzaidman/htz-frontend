...
import IconMarkerLogo from '../IconMarkerLogo';

describe('<IconMarkerLogo />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconMarkerLogo size="2rem" />)).toThrow(
  ...
  describe('styles', () => {
    testCase(
      "set icon's color",
      <IconMarkerLogo color={[ 'primary', 'base', ]} />
    );
    testCase(
    ...
    testCase("set icon's fill", <IconMarkerLogo fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's size", <IconMarkerLogo size={6} />);
    testCase(
    ...
    testCase(
      ...
      <IconMarkerLogo miscStyles={{ position: 'relative', }} />
    );
    testCase(
