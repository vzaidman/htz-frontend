...
describe('<IconStar />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconStar size="2rem" />)).toThrow(
  ...
  describe('styles', () => {
    ...
    testCase("set icon's fill", <IconStar fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase(
      ...
      <IconStar miscStyles={{ position: 'relative', }} />
    );
    testCase(
