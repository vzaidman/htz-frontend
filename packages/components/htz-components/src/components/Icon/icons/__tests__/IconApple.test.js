...
describe('<IconApple />', () => {
  ...
  //     expect(() => felaSnapshotter(<IconApple size="2rem" />)).toThrow(
  ...
  //     expect(() => felaSnapshotter(<IconApple color="red" />)).toThrow(
  //       /is not a named-color/
  //     );
  //   });
  //   it('throw an error when the value passed to the "color" prop isn't a named color (array of strings)', () => {
  //     expect(() =>
  //       felaSnapshotter(<IconApple color={[ 'primary', 'nope', ]} />)
  //     ).toThrow(/is not a named-color/);
  //   });
  //   it('throw an error when the value passed to the "fill" prop isn't a named color (string)', () => {
  //     expect(() => felaSnapshotter(<IconApple fill="red" />)).toThrow(
  //       /is not a named-color/
  //     );
  //   });
  //   it('throw an error when the value passed to the "fill" prop isn't a named color (array of strings)', () => {
  //     expect(() =>
  //       felaSnapshotter(<IconApple fill={[ 'primary', 'nope', ]} />)
  //     ).toThrow(/is not a named-color/);
  //   });
  // });
  describe('DOM element', () => {
    testCase('render correctly when no props are passed', <IconApple />);
    testCase(
      'pass attributes defined in the "attrs" prop to the DOM element',
      <IconApple attrs={{ 'aria-hidden': true, }} />
    );
    testCase('add "id" attribute to DOM element', <IconApple id="hasId" />);
    testCase(
      'add "onClick" attribute to DOM element',
      <IconApple id={e => console.log('a')} />
    );
  });

  describe('styles', () => {
    testCase("set icon's color", <IconApple color={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase("set icon's fill", <IconApple fill={[ 'primary', 'base', ]} />);
    testCase(
    ...
    testCase(
      ...
      <IconApple miscStyles={{ position: 'relative', }} />
    );
    testCase(
