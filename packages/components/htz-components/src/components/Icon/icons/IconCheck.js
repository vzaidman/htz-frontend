...
const IconCheck = createComponent(iconStyle, UnstyledIconCheck, [
  'attrs',
  'onClick',
]);
...
UnstyledIconCheck.propTypes = {
  attrs: attrsPropType,
};

UnstyledIconCheck.defaultProps = {
  attrs: null,
};

function UnstyledIconCheck({ attrs, ...props }) {
  return (
    <svg
      width="1em"
      height="1em"
