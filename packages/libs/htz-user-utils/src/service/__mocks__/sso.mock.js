...
export const loginFailureResponse =
  "null('error','nothing','הדואר האלקטרוני או הסיסמה שהוזנו אינם קיימים במערכת')";
export const logoutFailureResponse =
  "null('error','nothing','המערכת נתקלה בבעיה בתהליך, נסה שנית מאוחר יותר')";
export const registerFailureResponse =
  "null('error','nothing','כתובת הדואר האלקטרוני הזו קיימת במערכת . אנא נסו כתובת אחרת')";
...
export const imageSuccessResponse =
  'https://devsso.haaretz.co.il/sso/sso/setDomainCookie?userId=7726894474&password=3dbe00a167653a1aaee01d93e77e730e&ticketId=3839373836323134393235353239343034373937&site=80&returnType=image';
