 ...
 * @param breakpoints the breakpoints from the globalConfig
 ...
 * @param {object} breakpoints - the breakpoints from the breakpoint config
 * @returns {string} breakpoint - the breakpoint label that the current width represents,
 * as a string
 */
export function getBreakpointName(breakpoint, breakpoints) {
