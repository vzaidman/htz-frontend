...
const generateStrings: GenerateStringsType =
  (numberOfStrings, stringLength, isUpperCase, isCapital) => {
...
const word: WordType =
  ({ count = 1, minLength = 0, maxLength = 8, upperCase = false, capital = false, }) => {
